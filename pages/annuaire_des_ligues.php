...
<html>
	...
	<head>
		<title>Annuaire des ligues</title>
		<meta charset="UTF-8">
	...
	<body id="dernieres-nouvelles">
		<header>
			<div class="menu" id="menu">
				...
				<ul>
					...
					<li><a class="current" href="/PPE/pages/annuaire_des_ligues.php">Annuaire des ligues</a></li>
		...
		<main >
			...
			<?php
				...
				$requete = "SELECT numLigue, nomLigue FROM ligue";
				$stmt = $pdo->query($requete);
				echo "<ul class='liste'>";
				foreach ($stmt as $donnee)
				{
					echo "<li><a href='/PPE/pages/ligue.php/?ligue=" . (string)$donnee["numLigue"] . "'>" . $donnee["nomLigue"] . "</a></li>";
				}
				echo "</ul>";
			?>
