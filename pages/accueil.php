		...
		<main>
			...
			<div style="display: flex; justify-content: space-around; width:100%;">
				<div class="image_container">
					<div class="image_rationalizer">
						<img class="responsive_element" src="/PPE/img/judo.png">
					</div>
				</div>
				<div class="image_container">
					<div class="image_rationalizer">
						<img class="responsive_element" src="/PPE/img/tennis.png">
					</div>
				</div>
				<div class="image_container">
					<div class="image_rationalizer">
						<img class="responsive_element" src="/PPE/img/badminton.png">
					</div>
				</div>
				<div class="image_container">
					<div class="image_rationalizer">
						<img class="responsive_element" src="/PPE/img/handball.png">
					</div>
				</div>
			</div>
			...
			<div class="video_container">
				<div class="video_rationalizer">
					<iframe class="responsive_element" width="560" height="315" style="display:block; margin-left:auto; margin-right:auto;" src="https://www.youtube.com/embed/mB2Vw3hhxnI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
